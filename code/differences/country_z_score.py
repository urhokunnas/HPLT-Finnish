...
with open ("C:/Users/shkunn/Downloads/country_output.txt") as file:
    f = file.read()
    f_json = json.loads(f)
    for country, content in f_json.items():
        ...
        if total < 1000: #ignore countries with less than 1000 texts to get more significant results
            continue
...
with open ("C:/Users/shkunn/Documents/results/country_tld_z_score_1000.txt", "a") as f:
    f.write("Top 50 country + tld combinations with the largest z-scores (countries with at least 1000 texts):\n")
    for d in tld_deviations[:50]:
       json.dump(d,f)
       f.write("\n\n")

with open ("C:/Users/shkunn/Documents/results/country_register_z_score_1000.txt", "a") as f:
    f.write("Top 50 country + register combinations with the largest z-scores (countries with at least 1000 texts):\n")
    for d in register_deviations[:50]:
       json.dump(d,f)
       f.write("\n\n")

with open ("C:/Users/shkunn/Documents/results/country_region_z_score_1000.txt", "a") as f:
    f.write("Top 50 country + region combinations with the largest z-scores (countries with at least 1000 texts):\n")
